      ...
      <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 20 }}>
        <div style={S.card}>
          ...
          <div style={{ display: "flex", flexDirection: "column", gap: 10 }}>
            ...
            {myPosts.map(item => {
              ...
              return (
                <div key={item.id} style={{ display: "flex", alignItems: "center", gap: 12, padding: "10px 14px", background: "#0D1421", borderRadius: 10 }}>
        ...
        <div style={S.card}>
          ...
          <div style={{ display: "flex", flexDirection: "column", gap: 10 }}>
            ...
            {myClaims.map(c => (
              <div key={c.claim_id} style={{ display: "flex", alignItems: "center", gap: 12, padding: "10px 14px", background: "#0D1421", borderRadius: 10 }}>
                ...
                <span style={S.badge(C.amber, "#1A140A")}>✓ {c.status}</span>
              </div>
            ))}
          </div>
        </div>
